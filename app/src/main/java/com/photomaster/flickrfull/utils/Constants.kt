...
const val OAUTH_SECRET_TOKEN_KEY = "gdfshshfsdh@!E"
const val OAUTH_TOKEN_KEY = "gdfshsfdsfsfhfsdh@!E"
const val OAUTH_KEY = "dsgearhr53#@R"
const val USER_ID_KEY = "dsggdfdcgearhr53#@R"